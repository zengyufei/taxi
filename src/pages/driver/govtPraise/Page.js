...
let Index = option => {
  ...
  function toExport(e) {
    ...
    window.location.href = `/driver/govtPraise/export.htm?token=${token}&${paramsForGet}`
  }
  ...
  const importCar = {
    name: 'file',
    action: `/driver/govtPraise/import.htm?token=${token}`,
    headers: {
...
function mapStateToProps({ loading, govtPraiseStore }) {
  return {
