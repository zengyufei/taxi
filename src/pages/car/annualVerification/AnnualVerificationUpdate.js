...
let AnnualVerificationUpdate = (props) => {
  const { dispatch, form, annualVerification } = props;
  const { getFieldDecorator } = form;
  const { previewVisible, previewImage, plateList, plateImage, synthesizeFileList, synthesizeFile, taximeterFileList, taximeterFile, drivingLicenseFileList, drivingLicenseFile } = props;
