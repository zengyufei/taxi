...
let AnnualVerificationAdd = (props) => {
  const { dispatch, form, car, carNos } = props;
  const { getFieldDecorator } = form;
  const { previewVisible, previewImage, plateList, synthesizeFileList, synthesizeFile, taximeterFileList, taximeterFile, drivingLicenseFileList, drivingLicenseFile } = props;
