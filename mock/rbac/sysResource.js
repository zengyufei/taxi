...
const { jsonUtils, mockUtils: { init, add, update, del, queryById, reload, queryList } } = require('../utils')
const { resourceContant } = require('../constant')
...
const finalResources = { ...firstResources, ...secondResources, ...threeResources }
